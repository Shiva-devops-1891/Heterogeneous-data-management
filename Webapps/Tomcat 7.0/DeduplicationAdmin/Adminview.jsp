        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="form_wrap">
                            <h3>Menu</h3>
                           <a href="UserView.jsp" class="button" style="vertical-align:middle">User Details</a>
                           <br>
                           <br>
                            <a href="FileView.jsp" class="button" style="vertical-align:middle">File Details</a>
                    </div>
                </div>
