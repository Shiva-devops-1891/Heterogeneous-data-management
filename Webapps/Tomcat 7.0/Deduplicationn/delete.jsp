											...
											<td>
												<center>
													<button style="color: blue;">
														<a
															href="Delete?ofile=<%=ofile%>&file=<%=files%>&hash=<%=hash%>&email=<%=uemail%>"
															style="border: thin; color: #b50b90;">Delete</a>
													</button>
												</center>
											</td>
										</tr>
