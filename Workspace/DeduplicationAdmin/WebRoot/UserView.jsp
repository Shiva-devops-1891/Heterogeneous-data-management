...
<%@page import="service.DBConnection"%><!doctype html>
...
<center>
		<table id="customers">
			...
			List<RegPojo> list = db.getUserDetails();

			for (RegPojo pojo : list) {
		...
		%>
			...
			<a href="Accept?email=<%=pojo.getEmail() %>">Accept </a></td>
			
			
			<td>
			<a href="Delete?email=<%=pojo.getEmail() %>">Delete </a></td>
